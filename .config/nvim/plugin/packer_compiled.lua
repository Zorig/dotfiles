...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "friendly-snippets", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "cmp-cmdline", "cmp-treesitter" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-multiple-cursors', 'nerdcommenter', 'gitsigns.nvim', 'indentLine'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-lspconfig'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-surround', 'nvim-cmp', 'nvim-ts-autotag', 'nvim-lspconfig', 'copilot.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'neoscroll.nvim', 'which-key.nvim', 'nvim-notify', 'telescope.nvim', 'vim-wakatime'}, { event = "VimEnter *" }, _G.packer_plugins)]]
